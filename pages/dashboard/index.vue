...
<div class="antialiased bg-black w-full text-slate-300 relativ">
    <div class="grid grid-cols-12 gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 px-2">
        <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4 ">
            ...
            <div id="menu" class="flex flex-col space-y-2 my-5">
                ...
                <a href="#" class="rounded-lg py-3 px-2 group absolute bottom-0">
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        <div>
                            <svg style="color: red" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" fill="red"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>      
                        </div>
                        <div>
                        <p class="font-bold text-base lg:text-lg text-red leading-4">Log out</p>
                        <!-- <p class="text-slate-400 text-sm hidden md:block">Edit settings</p> -->
                        </div>
        ...
        <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6 h-screen">
            <div id="24h">
